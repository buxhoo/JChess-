...
import com.jchess.engine.pieces.Pawn;
import com.jchess.engine.pieces.Piece;
import com.jchess.engine.pieces.Rook;

import static com.jchess.engine.board.Board.*;
...
public abstract class Move {
    ...
    public static final class KingCastleMove extends CastleMove{
        public KingCastleMove(final Board board, final Piece movedPiece, final int destinationCoordinate,
                              final Rook castleRook, final int castleRookStart, final int castleRookDestination){
    ...
    public static final class QueenCastleMove extends CastleMove{
        public QueenCastleMove(final Board board, final Piece movedPiece, final int destinationCoordinate,
                               final Rook castleRook, final int castleRookStart, final int castleRookDestination){
            super(board, movedPiece, destinationCoordinate, castleRook, castleRookStart, castleRookDestination);
        }
        @Override
    ...
    public static class MoveMachine{
        private MoveMachine(){
            throw new RuntimeException("Not Instantiable");
        }
        public static Move createMove(final Board board, final int currentCoordinate, final int destinationCoordinate){
            for(final Move move : board.getAllLegalMoves()){
                if(move.getDestinationCoordinate() == currentCoordinate && move.getDestinationCoordinate() == destinationCoordinate){
                    return move;
                }
            }
            return NULL_MOVE;
